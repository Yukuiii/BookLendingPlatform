...
import { ChevronDown, Eye, EyeOff, IdCard, LockKeyhole, Mail, Phone, UserRound } from 'lucide-vue-next'
...
<template>
  <AuthLayout title="图书借阅管理系统" subtitle="创建您的账户并开启便捷借阅之旅" mode="register">
